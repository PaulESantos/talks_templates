...
##  {background-iframe="boids_/index.html"}
...
![](images/classical-ml.png){fig-align="center" width="100%"}
...
![](images/classical-ml-annotated.png){fig-align="center" width="100%"}
...
::: fontsize40
Models [don't]{.green} have outcomes

<br>

[No]{.green} clearly defined `predict()`
...
Remember to mention scales of the data
:::
...
once fit we want to do a couple of things
:::
...
```{r}
tot_wss <- sse_within_total(kmeans_fit, new_data = dates)
```
...
![](images/tidyclust.png){.nostretch style="border-radius: 50%;" width="200px"}
